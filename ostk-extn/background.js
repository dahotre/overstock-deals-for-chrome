chrome.cookies.get({url:"http://www.dahotre.com", name:"extn"}, function(cookie){
...
chrome.cookies.set({url:"http://www.dahotre.com", name:"extn", value:Date.today().toString('yyyyMMdd')}, function(cookie){});
